//all code of database was download from internet

package pl.mojefilmy.database.dao;
...
import pl.mojefilmy.database.models.BaseModel;
import pl.mojefilmy.utils.FxmlUtils;
